      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <a
            ...
            className="w-full inline-flex items-center justify-center gap-2 p-4 rounded-xl bg-white/[0.04] border border-white/10 hover:border-white/20 text-gray-200 hover:text-white font-mono text-xs transition-colors group"
          >
            <span>Visit @dheeraj-srma on GitHub</span>
            <ArrowUpRight size={14} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
          </a>

          {/* NEW: Commit Activity & Velocity Telemetry Card (Fills the Empty Space) */}
          <SpotlightCard className="p-6 space-y-5 border border-white/10 hover:border-emerald-500/30 transition-all">
            {/* Header */}
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
        ...
        <div className="lg:col-span-7 space-y-3">
          ...
          <div className="space-y-3">
            {stats.recentRepos.map((repo) => (
              ...
              >
                <SpotlightCard className="p-5 border border-white/10 hover:border-blue-500/40 transition-all duration-300">
                  ...
                  <div className="flex items-center justify-between pt-3 mt-3 border-t border-white/5 text-[11px] font-mono text-gray-400">
